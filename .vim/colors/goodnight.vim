...
call H("Question",     s:blue, "", "")
call H("Search",       s:selection_bg, s:yellow, "")
call H("IncSearch",    s:selection_bg, s:yellow, "")
call H("Substitute",   s:selection_bg, s:yellow, "none")
call H("SpecialKey",   s:comment, "", "")
call H("TooLong",      s:red, "", "")
call H("Underlined",   s:red, "", "")
call H("Visual", "",   s:selection_bg, "")
...
" Diff highlighting
call H("DiffAdd",      s:green, s:selection_bg, "")
call H("DiffChange",   s:yellow, s:selection_bg, "")
call H("DiffDelete",   s:red, s:selection_bg, "")
call H("DiffText",     s:blue, s:selection_bg, "")
