...
call H("CursorLineNr", s:b05, s:b00, "none")
...
call H("Todo",         s:b0A, s:b00, "italic")
...
" Diff highlighting
call H("DiffAdd",      s:b0B, s:b02, "")
call H("DiffChange",   s:b05, s:b02, "")
call H("DiffDelete",   s:b08, s:b02, "")
call H("DiffText",     s:b0D, s:b02, "")
