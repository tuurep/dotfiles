...
call H("@function.builtin",     s:blue, "", "")
call H("@function.call",        s:blue, "", "")
call H("@function.macro",       s:blue, "", "")
call H("@method",               s:blue, "", "")
call H("@method.call",          s:blue, "", "")
call H("@constructor",          s:blue, "", "")
...
call H("@type",                 s:fg, "", "")
call H("@type.builtin",         s:magenta, "", "")
call H("@type.definition",      s:fg, "", "")
call H("@type.qualifier",       s:magenta, "", "")
call H("@storageclass",         s:magenta, "", "")
call H("@attribute",            s:blue, "", "")
call H("@field",                s:fg, "", "")
...
call H("@constant.macro",       s:orange, "", "")
call H("@namespace",            s:fg, "", "")
call H("@symbol",               s:fg, "", "")
call H("@text",                 s:fg, "", "")
