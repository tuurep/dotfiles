...
hl(0, "QuickFixLine", { fg = bg,      bg = search })
hl(0, "QfLineNr",     { fg = fg,                  })
hl(0, "qfSeparator",  { fg = fg,                  })
...
hl(0, "DiffFile",      { fg = comment, bg = bg    })
hl(0, "DiffIndexLine", { fg = comment, bg = bg    })
hl(0, "DiffOldFile",   { fg = comment, bg = bg    })
hl(0, "DiffNewFile",   { fg = comment, bg = bg    })
...
hl(0, "@string.special.url",   { fg = cyan    })
...
hl(0, "@module",               { fg = fg      })
hl(0, "@module.builtin",       { fg = magenta })
hl(0, "@tag",                  { fg = red     })
...
hl(0, "@punctuation.special.latex", { fg = red  })
hl(0, "@markup.link.latex",         { fg = cyan })
...
-- :TSModuleInfo
hl(0, "TSModuleInfoGood", { fg = green })
hl(0, "TSModuleInfoBad",  { fg = red   })
