...
--      * Don't highlight search/substitute matches
...
vim.api.nvim_set_hl(0, "WinSeparator", { fg = ll_bg,   bg = ll_bg  })
...
-- Todo: LSP hover
vim.api.nvim_set_hl(0, "NormalFloat", { bg = ll_bg })
-- vim.api.nvim_set_hl(0, "FloatBorder", { bg = ll_bg })
...
vim.api.nvim_set_hl(0, "DiffLine",      { fg = cyan              })
vim.api.nvim_set_hl(0, "DiffFile",      { fg = cyan              })
vim.api.nvim_set_hl(0, "DiffSubName",   { fg = dd_fg             })
...
vim.api.nvim_set_hl(0, "zshPrecommand", { fg = magenta  })
...
-- LSP semantic highlights: disable all
